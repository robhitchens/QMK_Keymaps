...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    /* QWERTY */
	[_BASE] = LAYOUT_all(
		KC_ESC, KC_1, KC_2, KC_3, KC_4, KC_5, KC_6, KC_7, KC_8, KC_9, KC_0, KC_MINS, KC_EQL, KC_RGUI, KC_RGUI,
		KC_TAB, KC_Q, KC_W, KC_E, KC_R, KC_T, KC_Y, KC_U, KC_I, KC_O, KC_P, KC_LBRC, KC_RBRC, KC_BSPC,
		KC_LCTL, KC_A, KC_S, KC_D, F_SHIFT, KC_G, KC_H, J_SHIFT, K_RAISE, L_LOWER, KC_SCLN, KC_QUOT, KC_ENT,
		KC_LSFT, XXXXXXX, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_RSFT, XXXXXXX,
		KC_LGUI, KC_LALT, LOWER, TAPSPACE, XXXXXXX, RAISE, KC_RALT, KC_RGUI),

    [_GAMEMODE] = LAYOUT_all(
		KC_ESC, KC_1, KC_2, KC_3, KC_4, KC_5, KC_6, KC_7, KC_8, KC_9, KC_0, KC_MINS, KC_EQL, KC_RGUI, KC_RGUI,
		KC_TAB, KC_Q, KC_W, KC_E, KC_R, KC_T, KC_Y, KC_U, KC_I, KC_O, KC_P, KC_LBRC, KC_RBRC, KC_BSPC,
		KC_LCTL, KC_A, KC_S, KC_D, KC_F, KC_G, KC_H, KC_J, KC_K, KC_L, KC_SCLN, KC_QUOT, KC_ENT,
		KC_LSFT, XXXXXXX, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_RSFT, XXXXXXX,
		GUISPACE, KC_LALT, LOWER, KC_SPC, XXXXXXX, RAISE, KC_RALT, GUISPACE),

    [_SPACEFN] = LAYOUT_all(
		_______, KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, KC_F6, KC_F7, KC_F8, KC_F9, KC_F10, KC_F11, KC_F12, _______, XXXXXXX,
		_______, KC_EXLM, KC_AT, KC_HASH, KC_DLR, KC_PERC, KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN, KC_LCBR, KC_RCBR, KC_DEL,
		_______, _______, KC_GRV, KC_MINS, KC_EQL, KC_BSLS, KC_PIPE, KC_LBRC, KC_RBRC, _______, KC_COLN, KC_DQUO, _______,
		_______, XXXXXXX, _______, KC_TILD, KC_UNDS, KC_PLUS, _______, KC_LCBR, KC_RCBR, KC_LT, KC_GT, KC_QUES, _______, XXXXXXX,
    ...
    [_LOWER] = LAYOUT_all(
		...
		_______, XXXXXXX, KC_MS_WH_LEFT, KC_MS_BTN3, KC_MS_WH_RIGHT, _______, _______, _______, _______, _______, _______, _______, _______, XXXXXXX,
		_______, _______, _______, _______, XXXXXXX, _______, _______, _______),

    [_RAISE] = LAYOUT_all(
		_______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, XXXXXXX,
		_______, ALSFH_TAB, KC_UP, ALT_TAB, _______, _______, _______, KC_PSCR, KC_INS, KC_HOME, KC_PGUP, _______, _______, KC_DEL,
	...
	// 	_______, XXXXXXX, S(KC_Z), S(KC_X), S(KC_C), S(KC_V), S(KC_B), S(KC_N), S(KC_M), S(KC_COMM), S(KC_DOT), S(KC_SLSH), _______, XXXXXXX,
	// 	_______, _______, _______, _______, XXXXXXX, _______, _______, _______),

    [_SHIFTEXTRA] = LAYOUT_all(
		_______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, XXXXXXX,
	    _______, S(KC_Q), S(KC_W), S(KC_E), S(KC_R), S(KC_T), S(KC_Y), S(KC_U), S(KC_I), S(KC_O), S(KC_P), S(KC_LBRC), S(KC_RBRC), _______,
		_______, S(KC_A), S(KC_S), S(KC_D), S(KC_F), S(KC_G), S(KC_H), S(KC_J), S(KC_K), S(KC_L), S(KC_SCLN), S(KC_QUOT), S(KC_ENT),
		_______, XXXXXXX, S(KC_Z), S(KC_X), S(KC_C), S(KC_V), S(KC_B), S(KC_N), S(KC_M), S(KC_COMM), S(KC_DOT), S(KC_SLSH), _______, XXXXXXX,
    ...
    [_ADJUST] = LAYOUT_all(
		_______, BASE, GAMEMODE, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, XXXXXXX,
...
layer_state_t layer_state_set_user(layer_state_t state) {
  ...
  //Can't have a mix of both momentary layer triggers as well as the layer being a result of the tri_layer_state
  //state = update_tri_layer_state(state, _SPACEFN, _LOWER, _SHIFTEXTRA);
  return state;
}
